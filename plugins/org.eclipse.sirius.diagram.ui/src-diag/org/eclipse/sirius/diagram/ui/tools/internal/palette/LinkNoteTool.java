...
class LinkNoteTool extends CreationTool {
    ...
    class LinkNoteAdaptable implements IAdaptable {
        ...
        private DRepresentationDescriptor selectDescriptor(Session session) {
            SingleRepresentationTreeSelectionDialog dialog = new SingleRepresentationTreeSelectionDialog(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), session);
        ...
        public <T> T getAdapter(Class<T> adapter) {
            ...
            if (adapter == DRepresentationDescriptor.class) {
                if (linkedRepresentation == null) {
                    ...
                    linkedRepresentation = selectDescriptor(session);
                }
