...
public class SiriusNoteViewFactory extends NoteViewFactory {
    ...
    /**
     * Overridden to mark representation link note views with a special
     * annotation. 
     *
     * @inheritDoc
     */
    ...
    public View createView(IAdaptable semanticAdapter, View containerView, String semanticHint, int index, boolean persisted, final PreferencesHint preferencesHint) {
        ...
        if (element instanceof DRepresentationDescriptor) {
            EAnnotation marker = EcoreFactory.eINSTANCE.createEAnnotation();
            marker.setSource(SiriusNoteEditPart.LINK_NOTE_SOURCE);
            view.getEAnnotations().add(marker);
        }
